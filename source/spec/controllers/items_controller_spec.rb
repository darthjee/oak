...
RSpec.describe ItemsController, type: :controller do
  ...
  describe 'GET #new' do
    ...
    context 'when format is JSON' do
      let(:expected) do
        Oak::Item::FormDecorator.new(Oak::Item.new(category:)).as_json
      end
  ...
  describe 'POST #create' do
    ...
    let(:expected) { Oak::Item::FormDecorator.new(created_item).as_json }
    let(:links_data) { [] }
    ...
    context 'when the request is invalid' do
      ...
      let(:expected) do
        Oak::Item::FormDecorator.new(expected_item.tap(&:validate)).as_json
      end
  ...
  describe 'PUT #update' do
    ...
    context 'when the request is valid' do
      ...
      it 'returns the updated item as JSON' do
        ...
        expected = Oak::Item::FormDecorator.new(item.reload).as_json
        expect(response_json).to eq(expected.stringify_keys)
      end
    end
    ...
    context 'when the request is invalid' do
      ...
      it 'returns validation errors as JSON' do
        ...
        expected = Oak::Item::FormDecorator.new(expected_item.tap(&:validate)).as_json
