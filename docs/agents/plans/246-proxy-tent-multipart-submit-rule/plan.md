...
- Once #252 lands and a `proxy` agent exists, future work on `docker_volumes/proxy_configuration/` and `proxy/` should move to it — this plan doesn't reassign retroactively.
